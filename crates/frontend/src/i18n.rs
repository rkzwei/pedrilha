...
pub struct Dict {
    ...
    pub admin_sync_acclaimed_title: &'static str,
    pub admin_sync_acclaimed_desc: &'static str,
    pub admin_sync_acclaimed_btn: &'static str,
...
pub const EN: Dict = Dict {
    ...
    admin_sync_acclaimed_title: "Sync Acclaimed",
    admin_sync_acclaimed_desc: "Ingest audience-canonized classics: sync candidates, enrich, classify acclaimed. 1–5 min.",
    admin_sync_acclaimed_btn: "Sync Acclaimed",
...
pub const PT: Dict = Dict {
    ...
    admin_sync_acclaimed_title: "Sincronizar Aclamados",
    admin_sync_acclaimed_desc: "Ingere clássicos consagrados pelo público: sincroniza candidatos, enriquece e classifica. 1–5 min.",
    admin_sync_acclaimed_btn: "Sincronizar Aclamados",
